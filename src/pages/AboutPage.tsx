...
const interns = [
  {
    name: 'G Dhruvann',
    role: 'Developer',
    description: 'A proactive developer contributing to diverse solutions across the organization, actively driving development initiatives and collaborating on cross-functional projects.',
  },
  {
    name: 'Revanth K',
    role: 'Developer',
    description: 'A versatile developer contributing to the design and delivery of impactful solutions across the organization.',
  },
];
